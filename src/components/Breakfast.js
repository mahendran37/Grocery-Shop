...
const vegetable = [
  ...
  { id: 4, name: 'Onion Favour&Potato', price: 45, lable: '110%', image: cadimg4, rating: 3 },
  { id: 5, name: 'Salted Instant Popcorn', price: 33, oldprice: 41, lable: 'Hot', image: cadimg5, rating: 3 },
  { id: 6, name: 'Blueberry Greak Yogurt', price: 50, lable: '15%', image: cadimg6, rating: 3 },
  { id: 7, name: 'Britania Cheeses Slice', price: 28, oldprice: 24, image: cadimg7, rating: 3 },
  { id: 1, name: 'Kellogs Original Cereals', price: 27, oldprice: 42, lable: 'sale', image: cadimg8, rating: 3 },
  { id: 1, name: 'Slurrp Millet Chocolate', price: 32, lable: '12%', image: cadimg9, rating: 4 },
  { id: 1, name: 'Amul Butter 500g', price: 28, oldprice: 33, image: cadimg10, rating: 3 },
]
