    ...
    <>
      <div className="container">
        ...
        <Carousel >
          ...
          <Carousel.Item>
            <img className=' bike d-block w-80 py-3' src={bannerimg1} alt='bannerimg2' />
            <Carousel.Caption >
            ...
            <p>Gonvenient shopping with great Discount</p>
            <button className='btn btn-primary'>Shop now</button>
            </Carousel.Caption>
          </Carousel.Item>
          
          <Carousel.Item>
            <img className='bike d-block w-80 py-3' src={bannerimg2} alt='banner3' />
            <Carousel.Caption >
              <span className='badge bg-warning text-dark'>Free Shipping</span>
              <h3 className='text-dark'>Free Shipping on Orders over $100</h3>
              <p>Free shipping for first-time customer only after promotion and discount are applied</p>
              <button className='btn btn-primary'>Shop now</button>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
