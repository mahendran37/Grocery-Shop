...
const Footer = () => {
  return (
    <footer className=" pt-5 pb-" style={{backgroundColor:'lightblue',}}>
      <div className="container text-left text-md-start">
        <div className="row mb-4">
          ...
          <div className="col-md-4 mb-3">
            ...
            <img src={footerimg1} alt="App Store" width="120" className="m-1 store-logo" />
            <img src={footerimg2} alt="Play Store" width="120" className="m-1 store-logo" />  {/* Freshcart Programs */}
          <div className="col-md-2 mt-3">
            <h5 className="fw-bold">Freshcart programs</h5>
            <ul className="list-unstyled">
              <li>Gift Cards</li>
